  ...
  return (
    <main className="min-h-screen pb-24" style={{ background: "var(--bg)", color: "var(--text)" }}>
      <div className="max-w-md mx-auto px-5 pt-4">
        ...
        <div className="rounded-2xl p-4 mb-6 flex gap-3" style={{ background: "var(--card)", border: "1px solid var(--line)" }}>
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "var(--muted)" }}>Elegí servicio, día y hora.</p>
          </div>
        </div>
